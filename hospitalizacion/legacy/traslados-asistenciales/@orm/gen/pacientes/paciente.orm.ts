...
import {
  ...
  TipoReingresoType,
  GrupoEstanciaType,
} from '@hpn/lgc/tas/types/gen';
import { CausaIngresoType, FormaIngresoType } from '@hpn/lgc/tas/types/temp';
import { EstanciaOrm } from '@hpn/lgc/tas/orm/temp';
import { EntidadBasicaRes } from '@common/infrastructure/responses';
import { TDiagnosticoRes } from '@hpn/lgc/tas/application/responses';
