...
const ESP_SOL_CARG_COLABORADOR = new EstadoEspecificoType(91, 'CARGADA POR COLABORADOR');
...
export function solEstadoEspecificoTypeFactory(
  ...
  switch (code) {
    ...
    case 91:
      return ESP_SOL_CARG_COLABORADOR;
    case 92:
...
export const SOL_ESTADOS_ESPECIFICOS = {
  ...
  SOL_CARG_COLABORADOR: ESP_SOL_CARG_COLABORADOR,
