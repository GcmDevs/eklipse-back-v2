...
import { AgregarOrdenCompraDto } from '@inn/lgc/ctc/presentation/dtos';
import {
  DetalleOrdenActivoOrm,
  DetalleOrdenCompraOrm,
  DocumentoOrm,
} from '@inn/lgc/ctc/orm/inn/documentos';
import {
  TIPOS,
  ESTADOS,
  ESTADOS_ESPECIFICOS,
...
import { TIPOS_DOCUMENTO } from '@inn/lgc/ctc/@types/inn/documentos';
